...
nmap('d<leader>', '<cmd>normal! "_0d$<cr>', { desc = 'Clear Current Line' })
...
nmap({ '<leader><tab>0', '<c-1>' }, '<cmd>tabfirst<cr>', { desc = 'Go to First Tab' })
nmap({ '<leader><tab>$', '<c-0>' }, '<cmd>tablast<cr>', { desc = 'Go to Last Tab' })
...
nmap(
  { '<leader><tab>h', '<c-h>' },
  "<cmd>silent! execute 'tabprevious ' . v:count1<cr>",
  { desc = 'Previous Tab' }
)
nmap(
  { '<leader><tab>l', '<c-l>' },
...
nmap(
  { '<c-s-1>', '<leader><s-tab>0', '<leader><s-tab>)' },
  '<cmd>0tabmove<cr>',
  { desc = 'Move Tab to the First' }
)
nmap(
  { '<c-s-0>', '<leader><s-tab>4', '<leader><s-tab>$' },
  '<cmd>$tabmove<cr>',
